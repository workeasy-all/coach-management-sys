...
CREATE TABLE MSTR_TEACHER(
    ...
    ,TCHR_PANCARD VARCHAR2(10) NOT NULL
...
CREATE TABLE MAP_TCHR_SUB(
    MTS_ID VARCHAR2(100) PRIMARY KEY
    ,MTS_TCHR_ID VARCHAR2(100) NOT NULL references MSTR_TEACHER(TCHR_ID)
    ,MTS_SUB VARCHAR2(100) NOT NULL references MSRT_SUB(SUB_ID)
    ,MTS_BR_ID VARCHAR2(100) NOT NULL references CC_BRANCH(CC_BR_ID)
)
